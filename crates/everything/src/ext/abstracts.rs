...
pub trait AbstractExt {
    ...
    const ARITHMETIC_OVERFLOW: Abstract = Abstract(2148566534810416742677953060919673359);

    /// Denotes that the result of a computation is undefined
    /// for the given inputs.
    const UNDEFINED: Abstract = Abstract(2148566534810416742677953060919673360);
}
